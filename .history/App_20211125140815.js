...
class App extends Component
{
  render()
  {
    ...
    <QulityPar name="Experience"/>
      ...
      <Image style={{,marginRight:-5,borderRadius:5,backgroundColor:"#fff"}} source={{uri:"https://www.maryville.edu/wp-content/uploads/2015/11/Linkedin-logo-1-550x550-300x300.png",width:50,height:50}}/>

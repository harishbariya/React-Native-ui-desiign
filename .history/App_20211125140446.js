...
class App extends Component
{
  render()
  {
    ...
    <QulityPar name="Experience"/>
       ...
       <View style={{flexDirection:"row"}}>
      <Image style={{borderRadius:10}} source={{uri:"https://png.pngtree.com/element_our/png_detail/20181015/facebook-logo-icon-design-vector-png_124139.jpg",width:50,height:50}}/>
      <Text>I</Text>
      </View>

...
class App extends Component
{
  render()
  {
    ...
    <QulityPar name="Experience"/>
      ...
      <Image style={{borderRadius:5}} source={{uri:"https://png.pngtree.com/element_our/png_detail/20181015/facebook-logo-icon-design-vector-png_124139.jpg",width:50,height:50}}/>
     
      <Image style={{borderRadius:5,backgroundColor:"#fff"}} source={{uri:"https://www.maryville.edu/wp-content/uploads/2015/11/Linkedin-logo-1-550x550-300x300.png",width:50,height:50}}/>

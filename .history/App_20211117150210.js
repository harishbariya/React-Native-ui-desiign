...
class App extends Component
{
  render()
  {
    return(
      ...
      ,width:90,height:90}}/>
        <Text style={[styles.textstyles,{color:"#000",fontSize:30,fontWeight:"bold"}]}>Harish Baria</Text>
        <Text style={[styles.textstyles,{fontSize:24}]}>Mobile App Developer</Text>
      <Text style={{color:"#000",fontSize:16,textAlign:"auto"}}>Hello Developers.I am a Mobile App and Web Developer with industry Experience.</Text>
    ...
    <QulityPar name="Experience"/>
       ...
       <QulityPar name="Personal Info"/>
          ...
          <View>
            <Button style={{backgroundColor:"tomato",padding:7,marginHorizontal:15,borderRadius:50}}>Download CV</Button>
          </View>
      </View>
